...
vsi_nn_graph_t * vnn_CreateYolov8n
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Transpose_Transpose_184/out0_0:out0 */
    attr.size[0] = 144;
    attr.size[1] = 80;
    attr.size[2] = 80;
    attr.size[3] = 1;
    ...
    /* @attach_Transpose_Transpose_200/out0_1:out0 */
    attr.size[0] = 144;
    attr.size[1] = 40;
    attr.size[2] = 40;
    attr.size[3] = 1;
    ...
    /* @attach_Transpose_Transpose_216/out0_2:out0 */
    attr.size[0] = 144;
    attr.size[1] = 20;
    attr.size[2] = 20;
    attr.size[3] = 1;
...
error:
    ...
    vnn_ReleaseYolov8n( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateYolov8n() */

void vnn_ReleaseYolov8n
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
